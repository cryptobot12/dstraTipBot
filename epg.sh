...
COIN_DAEMON='/usr/local/bin/epgcd'
COIN_CLI='/usr/local/bin/epgc-cli'
COIN_REPO='https://github.com/Encocoin/encocoinplus/releases/download/1.0.2/epgc-1.0.2-aarch64-linux-gnu.zip'
